...
public class Email_Gmail {
	...
	public void configureEmail(Properties prop, List<ExlData> excelDataList) throws AddressException, MessagingException{
		...
		prop2.put("mail.smtp.starttls.enable", "true");
		prop2.put("mail.smtp.host", "smtp.gmail.com");
		prop2.put("mail.smtp.port", "465");
		prop2.put("mail.smtp.socketFactory.port", "465");
	    prop2.put("mail.smtp.socketFactory.class","javax.net.ssl.SSLSocketFactory");  
	    prop2.put("mail.smtp.socketFactory.fallback", "false");
